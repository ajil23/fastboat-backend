                                                ...
                                                <td>
                                                    <div class="dropstart">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item" id="edit-btn" href="javascript:void(0)" 
                                                                data-id="{{ $item->rt_id }}" 
            ...
            <div class="modal-body">
                <form id="editRouteForm" action="" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="edit_rt_dept_island" name="rt_dept_island" placeholder="Enter Departured Island" required>
                    </div>
                    <div class="mb-3">
                        <label for="edit_rt_arrival_island" class="form-label">Arrival Island</label>
                        <input type="text" class="form-control" id="edit_rt_arrival_island" name="rt_arrival_island" placeholder="Enter Arrival Island" required>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-dark">Save</button>
