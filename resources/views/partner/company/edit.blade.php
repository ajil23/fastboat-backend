                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input id="cpn_phone" name="cpn_phone" type="text" class="form-control" value="{{$companyEdit->cpn_phone}}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="cpn_whatsapp"> Whatsapp</label>
                                                        <input id="cpn_whatsapp" name="cpn_whatsapp" type="text" class="form-control" value="{{$companyEdit->cpn_whatsapp}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
