                                                ...
                                                <center>
                                                    <div class="dropstart">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <a class="dropdown-item" href="{{ route('trash.customerEmail', $item->fbo_id) }}" id="=" style="color: rgb(66, 133, 244);"><i class="mdi mdi-email-send"></i>Customer Email</a>
                                                            <a class="dropdown-item" href="{{ route('trash.companyEmail', $item->fbo_id) }}" id="=" style="color: rgb(66, 133, 244);"><i class="mdi mdi-email-send"></i>Supplier Email</a>
                                                            <a class="dropdown-item" href="javascript:void(0)" id="showWhatsapp" data-url="{{ route('trash.whatsapp', $item->fbo_id) }}" style="color: rgb(37, 211, 102);"><i class="mdi mdi-whatsapp"></i>WhatsApp</a>
                                                            <a class="dropdown-item text-secondary removeStatus" href="javascript:void(0);" id="removeStatus" data-url="{{ route('trash.updateStatus', $item->fbo_id) }}"><i class="mdi mdi-inbox-remove"></i>Remove</a>
                                                            ...
                                                            <a class="dropdown-item" href="{{route('trash.edit', $item->fbo_order_id)}}" style="color: rgb(255, 90, 0);"><i class="mdi mdi-square-edit-outline"></i>Edit</a>
                                                        </div>
                                                    </div>
                                                </center>
                                            </td>
