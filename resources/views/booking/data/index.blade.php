                                                        ...
                                                        <center>
                                                            <div class="dropstart">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    ...
                                                                    <a class="dropdown-item" href="{{ route('data.customerEmail', $item->fbo_id) }}" id="=" style="color: rgb(66, 133, 244);"><i class="mdi mdi-email-send"></i>Customer Email</a>
                                                                    <a class="dropdown-item" href="{{ route('data.companyEmail', $item->fbo_id) }}" id="=" style="color: rgb(66, 133, 244);"><i class="mdi mdi-email-send"></i>Supplier Email</a>
                                                                    ...
                                                                    <a class="dropdown-item text-secondary removeStatus" href="javascript:void(0);" id="removeStatus" data-url="{{ route('data.updateStatus', $item->fbo_id) }}"><i class="mdi mdi-inbox-remove"></i>Remove</a>
