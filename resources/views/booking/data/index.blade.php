                                                        ...
                                                        <center>
                                                            <div class="dropstart">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    ...
                                                                    <a class="dropdown-item" href="{{ route('data.customerEmail', $item->order->ctc_id) }}" id="=" style="color: rgb(66, 133, 244);"><i class="mdi mdi-email-send"></i>Cust. Email</a>
                                                                    <a class="dropdown-item" href="{{ route('data.companyEmail', $item->fbo_id) }}" id="=" style="color: rgb(66, 133, 244);"><i class="mdi mdi-email-send"></i>Comp. Email</a>
