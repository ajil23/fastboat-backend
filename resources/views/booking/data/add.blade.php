                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-control" id="time_dept_return"
                                                            ...
                                                            @foreach ($availability as $item)
                                                                ...
                                                                @endphp
                                                                <option value="{{ date('H:i', strtotime($deptTime)) }}">
                                                                    {{ date('H:i', strtotime($deptTime)) }} </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <div class="mb-3">
                                                                <label class="form-label" for="adult_return_publish">Adult
                                                                    Publish (IDR)</label>
                                                                <input value="" class="form-control"
                                                                    id="adult_return_publish" name="adult_return_publish" oninput="calculateTotalReturn()">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <div class="mb-3">
                                                                <label class="form-label" for="child_return_publish">Child
                                                                    Publish (IDR)</label>
                                                                <input value="" class="form-control"
                                                                    id="child_return_publish" name="child_return_publish" oninput="calculateTotalReturn()">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <div class="mb-3">
                    ...
                    success: function(response) {
                        ...
                        if (response.show_shuttle_checkbox) {
                            ...
                            <div class="col-md-6 shuttle-inputs" style="display:none;" id="pickup-inputs">
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input value="" style="border-color: lightgray;" class="form-control" id="" name="">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        <label class="form-label" for="">Pickup Meeting Point</label>
                                        <input value="" style="border-color: lightgray;" class="form-control" id="" name="">
                                    </div>
                                    </div>
                                    </div>
                                    <div class="row">
                                            <div class="mb-3">
                                                <label class="form-label" for="">Address Pickup</label>
                            ...
                            <div class="col-md-6 shuttle-inputs" style="display:none;" id="dropoff-inputs">
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        <label class="form-label" for="">Dropoff Meeting Point</label>
                                        <input value="" style="border-color: lightgray;" class="form-control" id="" name="">
                                    </div>
                                </div>
                                </div>
                            <div class="row">
                                    <div class="mb-3">
                                        <label class="form-label" for="">Address Dropoff</label>
                                        <textarea value="" style="border-color: lightgray;" class="form-control" id="" name=""></textarea>
                                    </div>
                            </div>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function performSearchReturn(tripDateReturn, departurePortReturn, arrivalPortReturn, fastBoatReturn,
                ...
                adultCountReturn = adultCountReturn !== null ? adultCountReturn : $('#adult_count').val() ||
                1; // Default 1 dewasa
