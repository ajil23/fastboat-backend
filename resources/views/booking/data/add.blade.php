                                            ...
                                            <div id="search-results" style="display: none;">
                                                <div class="table-responsive">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <div class="mb-3">
                                                                <label class="form-label" for="fbo_end_total_currency">End Total
                                                                    Currency (IDR)</label>
                                                                <input value="" class="form-control"
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#fbo_trip_date, #fbo_departure_port, #fbo_arrival_port, #fbo_fast_boat, #time_dept').on('change', function() {
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" style="border-color: lightgray;" class="form-control" id="" name="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
