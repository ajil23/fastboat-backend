                                        ...
                                        <div class="btn-toolbar float-end" role="toolbar">
                                            <button class="btn btn-dark w-100" data-bs-toggle="modal"
                                                data-bs-target="#addDataModal"><i
                                                    class="mdi mdi-plus"></i>Point</button>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            @foreach ($checking as $item)
                                                <tr>
                                                    ...
                                                    <td>{{ $item->fcp_company }}</td>
                                                    <td>{{ $item->fcp_dept }}</td>
                                                    <td>{{ $item->fcp_address }}</td>
                                                    <td>{{ $item->fcp_maps }}</td>
                                                    <td>
                                                        <div class="dropstart">
                ...
                <div class="modal-content">
                    ...
                    <form action="{{ route('checking.store') }}" method="post">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="nas_country" class="form-label">Company</label>
                                <select name="fcp_company" id="fcp_company" class="form-control">
                            ...
                            <div class="mb-3">
                                <label for="nas_country_code" class="form-label">Departure Port</label>
                                <select name="fcp_dept" id="fcp_dept" class="form-control">
