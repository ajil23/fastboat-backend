                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input id="prt_code" name="prt_code" placeholder="Enter Island Code" type="text" class="form-control" required>
                                                    </input>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-control" data-trigger name="prt_island" id="prt_island">
