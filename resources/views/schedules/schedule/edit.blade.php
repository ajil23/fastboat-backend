...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            <form action="{{route('schedule.update', $scheduleData->sch_id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-12">
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 overflow-hidden">
                                                <h5 class="font-size-16 mb-1">Schedule Info</h5>
                                ...
                                <div id="addproduct-productinfo-collapse" class="collapse show" data-bs-parent="#addproduct-accordion">
                                    <div class="p-4 border-top">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="sch_name">Schedule Name</label>
                                                    <input id="sch_name" name="sch_name" placeholder="Enter Fast Boat Name" type="text" class="form-control" value="{{$scheduleData->sch_name}}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
