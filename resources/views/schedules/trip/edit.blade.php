                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="fbt_info_en" name="fbt_info_en" placeholder="Enter Content" rows="4">{{$tripEdit->fbt_info_en}}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="mb-3">
