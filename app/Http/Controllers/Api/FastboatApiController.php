        ...
        if ($data->scheduleTrips->isNotEmpty()) {
            $result['schedule_trips'] = $data->scheduleTrips->map(function ($scheduleTrip) {
                return [
                    ...
                    'arrival_time' => $scheduleTrip->fbt_arrival_time,
                    'departure_port_slug' => $scheduleTrip->deptPort ? $scheduleTrip->deptPort->prt_slug_idn : null,
                    'arrival_port_slug' => $scheduleTrip->arrivalPort ? $scheduleTrip->arrivalPort->prt_slug_idn : null,
                ];
            });
        }
