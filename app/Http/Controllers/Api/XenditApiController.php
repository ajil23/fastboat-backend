    ...
    public function index(Request $request)
    {
        ...
        if ($bookingOneWay) {
            $oneway = [
                ...
                'fbo_booking_id' => $bookingOneWay->fbo_booking_id,
                'fbo_trip_date' => $bookingOneWay->fbo_trip_date,
                'fbo_payment_status' => $bookingOneWay->fbo_payment_status,
                'fbo_departure_port' => $bookingOneWay->fbo_departure_port,
                'fbo_arrival_port' => $bookingOneWay->fbo_arrival_port,
        ...
        if ($bookingDepart && $bookingReturn) {
            ...
            $depart = [
                ...
                'fbo_booking_id' => $bookingDepart->fbo_booking_id,
                'fbo_trip_date' => $bookingDepart->fbo_trip_date,
                'fbo_payment_status' => $bookingDepart->fbo_payment_status,
                'fbo_departure_port' => $bookingDepart->fbo_departure_port,
                'fbo_arrival_port' => $bookingDepart->fbo_arrival_port,
            ...
            $return = [
                ...
                'fbo_booking_id' => $bookingReturn->fbo_booking_id,
                'fbo_trip_date' => $bookingReturn->fbo_trip_date,
                'fbo_payment_status' => $bookingReturn->fbo_payment_status,
                'fbo_departure_port' => $bookingReturn->fbo_departure_port,
                'fbo_arrival_port' => $bookingReturn->fbo_arrival_port,
