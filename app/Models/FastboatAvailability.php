...
class FastboatAvailability extends Model
{
    ...
    protected $fillable = ['fba_trip_id', 'fba_date', 'fba_dept_time', 'fba_arriv_time', 'fba_adult_nett', 'fba_child_nett', 'fba_adult_publish', 'fba_child_publish', 'fba_discount', 'fba_stock', 'fba_status', 'fba_shuttle_status', 'fba_info', 'fba_min_pax', 'fba_created_bt', 'fba_updated_by'];
